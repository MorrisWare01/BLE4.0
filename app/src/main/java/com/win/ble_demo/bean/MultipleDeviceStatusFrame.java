 ...
 */
public class MultipleDeviceStatusFrame {
    ...
    public static MultipleDeviceStatusFrame parse(String data) {
        MultipleDeviceStatusFrame frame = new MultipleDeviceStatusFrame();
